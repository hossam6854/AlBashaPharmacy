            ...
            <div className="max-h-72 overflow-y-auto pr-1 sm:pr-2 mb-6 space-y-3 custom-scrollbar">
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center space-x-2 rtl:space-x-reverse w-full sm:w-auto gap-5 sm:justify-start">
                    <div className="flex items-center bg-green-50 rounded-lg overflow-hidden">
                      <button
                        onClick={() => handleQuantityChange(item.id, -1)}
                        className="px-2 py-1 text-green-600 hover:bg-green-100 transition-colors"
                      >
                        <FiMinus size={16} />
                      </button>
                      <span className="px-2 text-green-800 font-semibold">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() => handleQuantityChange(item.id, 1)}
